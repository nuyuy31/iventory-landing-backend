...
class Laporan extends CI_Controller {
    ...
    public function barang_masuk_pdf()
    {
        ...
        // Pastikan view 'laporan/barang_masuk_pdf' sudah dibuat minimalis tanpa header/footer tambahan.
        $mpdf  = new \Mpdf\Mpdf();
    ...
    public function barang_keluar_pdf()
    {
        ...
        // Pastikan view 'laporan/barang_keluar_pdf' sudah dibuat minimalis.
        $mpdf  = new \Mpdf\Mpdf();
